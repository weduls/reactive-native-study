...
export const styles = StyleSheet.create({
    view: {backgroundColor: MD2Colors.lime100, padding: 5, flexDirection: 'row'},
    leftView: {padding: 5},
    ...
    email: {textDecorationLine: 'underline', color: MD2Colors.blue500, textDecorationColor: MD2Colors.blue500},
